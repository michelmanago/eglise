...
export default function EditorMenu({menus}) {
    ...
    return (
        <div>
            ...
            {/* Page home */}
            <div className="max-w-screen-xl p-8 px-10 py-10 pb-20 mx-auto bg-white border">
                <h1 className="mb-10 text-4xl font-bold">Modifier le menu de navigation</h1>
...
export async function getServerSideProps(context) {
    ...
    if (cookie) {
        ...
        authorize(res, parsedCookies, secret, `admin/editor-menu`);
    } else {
