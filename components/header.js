    ...
    switch (currentPage) {
        ...
        case 'histoire':
            ...
            switch (currentLanguage) {
                ...
                case 'en':
                    ...
                    alt =
                        'logo of the upkeep committee of the graves of the Russian cemetery of Sainte Geneviève des Bois';
                    break;
                case 'ru':
        ...
        default:
            if (currentPage.search('defunts') != -1) {
                ...
                throw 'Erreur. Page inconnue dans Header' + currentPage;
            }
    }
    return (
        <header>
            <div className="bg-white h-80px sm:h-115px">
            ...
            <div
                className={
                    topImageHook +
                    ' h-80px sm:h-165px flex items-top pt-2 sm:pt-0 sm:items-center justify-center text-white'
                }
            >
