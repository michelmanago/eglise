...
export default function Carousel({ imgList, legende, id }) {
    ...
    return (
        <div>
            <div className="h-auto my-6 overflow-hidden bg-white border md:max-w-full">
                                    ...
                                    {/* Copyright tooltip */}
                                    {
                                        credit && (
                                            <Popup
                                                ...
                                                trigger={
                                                    <span className="absolute text-gray-400 cursor-pointer left-4 top-4 hover:opacity-70">
