...
export default function PageInfo({media, author, created_at, last_modified, source}) {
    ...
    return (
        <Popup trigger={TriggerDOM} on={['hover', 'focus']} position={['right top']}>
            <div style={wrapperStyles} className="px-5 py-5 bg-gray-100 border rounded shadow-md">
                {/* Date créate page*/}
                {created_at && (
                    <div>
...
const TriggerDOM = (
    <div className="inline-flex items-center px-4 py-1 mb-3 border border-gray-300 rounded hover:bg-gray-200">
        {/* Icon */}
        <IconInfo />
