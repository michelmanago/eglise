			...
			<main>
				...
				<div className="w-full mt-1 py-6 overflow-hidden md:flex ">
					<div className="mx-2 sm:mx-20">
						...
						Le site du cimetiere russe, anciennement accessible à partir du présent site, a été relocalisé à l'adresse <a href="https://cimetiere-russe.org">cimetiere-russe.org</a>.
						...
						Ce dernier a été inscrit sur l'inventaire des sites pittoresques du département de l'Essonne en 1979 et à l'inventaire des monuments historiques en 2001. 
						...
						le plus grand cimetière russe à l’étranger.
						</p><p className="text-justify">
						...
						L'église construite en 1939 sous l’impulsion du métropolite Euloge, est de style novgorodien du XVème siècle avec un clocher lui de style pskovien. 
						Elle est l'œuvre de l'architecte et décorateur Albert Alexandrovich Benois et de son épouse Margarita Alexandrovna qui ont également réalisés 
						les fresques murales à l'intérieur de l'église et de la crypte. La nécropole russe constitue un patrimoine mondialement connu.
						</p>
					</div>
				</div>
