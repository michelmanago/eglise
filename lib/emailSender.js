...
export const sendEmailNewArticle = async article => {
    ...
    for (const adherent of adherents) {
        const message = {
            ...
            html: `<h3>Bonjour</h3>
            <p>Un nouvel article est disponible sur le site de l'Église Notre-Dame-de-la-Dormition</p>
            <p><a target="_" href="${process.env.DOMAIN}/${article.pageSlug}">${article.pageName}</a></p>
            `,
        };
        sendEmail(message);
    }
